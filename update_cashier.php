...
if(isset($_GET['username'])){
	...
	$get_pharmacist="select * from cashier where username='$username'";
...
if(isset($_POST['submit']))
{
	...
	$update_pharmacist1="update cashier set first_name='$new_pharmacist' ,last_name='$new_lname' , staff_id='$new_staff',postal_address='$new_postal' , phone='$new_phone' , email='$new_email', username='$new_username', password='$new_password' where username='$update_pharmacist'";
