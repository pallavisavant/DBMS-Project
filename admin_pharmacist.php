...
$user=$_POST['username'];
$pas=$_POST['password'];
$sql1=mysqli_query($con,"SELECT * FROM pharmacist WHERE username='$user'")or die(mysql_error());
...
<ul>
            ...
            <li><a href="staff_report.php"><p style="color: white;"><b>Staff report</b></p></a></li></br>
    ...
    <div class="tabbed_area">  
       ...
       $result = mysqli_query($con,"SELECT * FROM pharmacist")or die(mysql_error());
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_pharmacist.php?username=<?php echo $row['username']?>"><img src="images/11.png" width="35" height="35" border="0" /></a></td>
				<td><a href="delete_pharmacist.php?pharmacist_id=<?php echo $row['pharmacist_id']?>"><img src="images/12.jpg" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
